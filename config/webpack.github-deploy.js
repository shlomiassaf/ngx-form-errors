   ...
   plugins: [
     function() {
       this.plugin('done', function(stats) {
         ...
         execSync(`./node_modules/.bin/compodoc -p tsconfig.package.json --disablePrivateOrInternalSupport --disableSourceCode --theme laravel -d ${webpackConfig.output.path}/documentation`, {stdio:[0,1,2]});
